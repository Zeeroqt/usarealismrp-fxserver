...
Config.DumpsterSearchItems = {
	...
	{ name = "Metal Scraps", legality = "legal", quntity = 2, type = "misc", weight = 5 },
	{ name = "Cloth", legality = "legal", quntity = 2, type = "misc", weight = 1 },
	{ name = "Metal Spring", legality = "legal", quntity = 2, type = "misc", weight = 3 },
	{ name = "Plastic", legality = "legal", quntity = 2, type = "misc", weight = 2 },
	{ name = "Glass", legality = "legal", quntity = 2, type = "misc", weight = 2 },
	{ name = "Copper", legality = "legal", quntity = 2, type = "misc", weight = 3 } , 
	{ name = "Iron", legality = "legal", quntity = 2, type = "misc", weight = 5 },
	{ name = "Electronics", legality = "legal", quntity = 2, type = "misc", weight = 3 },
	{ name = "Electronic Kit", legality = "legal", quntity = 2, type = "misc", weight = 4 }
}
